...
""" Ansible module for managing Groups on Isilon"""
...
DOCUMENTATION = r'''
---
module: dellemc_isilon_group

version_added: "1.1.1"

short_description: Manage Groups on the Isilon Storage System
description:
- Managing Groups on the Isilon Storage System includes create group,
...
options:
  group_name:
    ...
    - Required at the time of group creation, for rest of the operations
            ...
            contains:
                sid:
                    ...
                    contains:
                        id:
                            description:
                                - The unique security identifier of the
                                  resource.
                            type: str
                        name:
                            description:
...
LOG = utils.get_logger('dellemc_isilon_group', log_devel=utils.logging.INFO)
HAS_ISILON_SDK = utils.has_isilon_sdk()
ISILON_SDK_VERSION_CHECK = utils.isilon_sdk_version_check()


class IsilonGroup(object):
    ...
    def __init__(self):
        ...
        self.module_params.update(get_isilon_group_parameters())
    ...
    def get_group_details(self, group, zone, provider):
        """Get the Group Details in Isilon"""
        try:
    ...
    def get_group_members(self, group, zone, provider):
        """Get the Group Member Details in Isilon"""
        try:
    ...
    def add_user_to_group(self, group, user,
                          zone, provider):
        """ Add a User to a Group in Isilon """
        try:
    ...
    def remove_user_from_group(self, group, user, zone, provider):
        """ Remove a user from a Group in Isilon"""
        try:
    ...
    def update_group(self, group, user_name, user_id,
        ...
        """Update the group members in Isilon"""
        changed = False
...
def get_isilon_group_parameters():
...
def main():
    """ Create Isilon Group object and perform actions on it
